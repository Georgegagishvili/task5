...
<div class="readers_comment">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#">
                <img alt="64x64" style = 'width:64px; height:64px;' data-src="assets/img/reader_img1.jpg"
                     src="https://icons555.com/images/icons-black/image_icon_guest_pic_512x512.png"data-holder-rendered="true">
            </a>
        </div>
        <div class="media-body">

            <h2 class="media-heading"><a href="#"></a>{{ $comment->name }}</h2>
            {{$comment->comment}}
...
<div class="entity_comments">
    ...
    <div class="entity_comment_from">
        <form action = '{{ route('storecomments')}}' method = 'POST'>
            ...
            <div class="form-group">
                <input type="text" class="form-control" id="inputEmail" placeholder="Email" name = 'gmail'>
            </div>
